...
class Project(Base):
    ...
    offer_creation_date = Column(String(50), nullable=True, comment="Дата создания КП из мастер-таблицы (TEXT)")
    offer_created_at = Column(DateTime, nullable=True, comment="Дата создания КП (TIMESTAMP для сортировки)")
