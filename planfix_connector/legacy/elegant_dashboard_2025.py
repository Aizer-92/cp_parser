#!/usr/bin/env python3
"""
Элегантный дашборд Planfix 2025
Современный дизайн без пустых блоков
"""
...
class ElegantDashboard:
    ...
    def get_dashboard_html(self, tasks, analytics):
        """Генерация HTML дашборда с элегантным дизайном"""
        ...
        <head>
            ...
            <title>Элегантный Дашборд Planfix 2025</title>
        ...
        <body>
            <div class="container">
                <div class="header">
                    <h1>🎯 Элегантный Дашборд Planfix 2025</h1>
                    <p>Комплексная аналитика задач с современным дизайном</p>
                </div>
    ...
    def run_dashboard(self):
        ...
        print(f"🚀 Запуск элегантного дашборда на порту {self.port}")
        print(f"📱 Откройте: http://localhost:{self.port}")
        app.run(host='0.0.0.0', port=self.port, debug=False)

def main():
    dashboard = ElegantDashboard()
