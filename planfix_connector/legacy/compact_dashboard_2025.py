#!/usr/bin/env python3
"""
Компактный дашборд Planfix 2025
Много блоков, маленькие диаграммы, правильные суммы
"""
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Компактная бизнес-аналитика</p>
        ...
        <div class="formula-box">
            <div class="formula-title">📐 Формула приоритета</div>
            <div class="formula-text">
Приоритет = (0.4 × (Грейд/5) + 0.4 × Фактор_суммы + 0.2 × (%_заказа/100))
Факторы: ≤250k:0.2 | ≤1M:0.4 | ≤5M:0.6 | ≤15M:0.8 | >15M:1.0
Классы: ≥0.8:A | ≥0.6:B | ≥0.4:C | <0.4:D
        ...
        <div class="charts-grid">
            <div class="chart-container">
                ...
                <canvas id="priorityChart" width="200" height="120"></canvas>
            </div>
            <div class="chart-container">
            ...
            <div class="chart-container">
                ...
                <canvas id="sumChart" width="200" height="120"></canvas>
            </div>
            <div class="chart-container">
                <div class="chart-title">👥 Грейды</div>
                <canvas id="gradeChart" width="200" height="120"></canvas>
            </div>
            <div class="chart-container">
                <div class="chart-title">🕐 По часам</div>
                <canvas id="hourlyChart" width="200" height="120"></canvas>
            </div>
            <div class="chart-container">
                <div class="chart-title">📅 По дням недели</div>
                <canvas id="weekdayChart" width="200" height="120"></canvas>
            </div>
        </div>
        ...
        for task in high_priority_tasks[:12]:
            html_content += f"""
                        <tr>
    ...
    <script>
        ...
        const sumData = {
            labels: ['0-250k', '250k-1M', '1M-5M', '5M-15M', '15M+'],
            datasets: [{
    ...
    def run(self, host='0.0.0.0', port=8055, debug=False):
        """Запуск дашборда"""
        print("🚀 Запуск компактного дашборда Planfix 2025...")
        print(f"🌐 Откройте браузер: http://localhost:{port}")
        print("⏰ Дашборд будет автоматически обновляться каждые 5 минут")
        print("🎯 Компактный дизайн с множеством блоков")
        self.app.run(host=host, port=port, debug=debug)

def main():
    dashboard = CompactDashboard2025()
    dashboard.run()
