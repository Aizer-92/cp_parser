#!/usr/bin/env python3
"""
Финальная перезагрузка данных - только товары с вариантами цен
"""
...
def main():
    print("🔄 Финальная перезагрузка данных...")
    
    # Очищаем базу данных
    clear_database()
    
    # Загружаем товары из основной таблицы (только те, что есть в parsed_products.json)
    ...
    # Загружаем товары из таблицы "Мерч для Sense" (только те, что есть в merch_sense_products.json)
    load_products_from_json(
