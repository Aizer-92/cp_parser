#!/usr/bin/env python3
"""
Универсальный парсер Excel файлов для коммерческих предложений
"""
...
def main():
    ...
    for excel_file in excel_files:
        ...
        try:
            ...
            print(f"❌ Ошибка при анализе {excel_file}: {e}")
            continue
    ...
    print("📄 Результаты сохранены в parsed_products.json")
